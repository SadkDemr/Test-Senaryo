(venv) C:\OtomasyoTool\backend>python -c "import pywinauto; import pyautogui; import pyperclip; print('OK')"
Traceback (most recent call last):
  File "<string>", line 1, in <module>
    import pywinauto; import pyautogui; import pyperclip; print('OK')
    ^^^^^^^^^^^^^^^^
